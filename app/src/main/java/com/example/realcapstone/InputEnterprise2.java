...
public class InputEnterprise2 extends AppCompatActivity {
    //기본으로는
    String databasename = "capstone.db";
    String sql = "";
    int dbversion = 1;
    SQLiteDatabase db;
    InputEnterprise2.DatabaseHelper handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_enterprise2);
        ...
        final int idnumber = intent.getExtras().getInt("enterid");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Licenset.length() == 0 ||
                        ...
                        Awardst.length() == 0 ||
                        Schoolt.length() == 0 ){
                    Toast toast = Toast.makeText(InputEnterprise2.this, "입력하지 않은 항목이 있습니다.", Toast.LENGTH_SHORT);
                    toast.show();
                    return;
                }
                databaseOpen(true);
                ...
                if (db != null) {
                    //입력완료
                    db.execSQL(sql);
                    Toast toast = Toast.makeText(InputEnterprise2.this, "기업입력완료!.", Toast.LENGTH_SHORT);
                    toast.show();
    ...
    private void databaseOpen(boolean f){
        handler = new InputEnterprise2.DatabaseHelper(this);
