...
public class Interview_Pass extends AppCompatActivity {
    //기본으로는
    String databasename = "capstone.db";
    String sql = "";
    int dbversion = 1;
    SQLiteDatabase db;
    Interview_Pass.DatabaseHelper handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interview__pass);
    ...
    private void databaseOpen(boolean f){
        handler = new Interview_Pass.DatabaseHelper(this);
